...
@implementation CouponSlectedCell
...
- (void)awakeFromNib {
    ...
    UIView *underView=[[UIView alloc]initWithFrame:CGRectMake(0, 44.0 - SINGLE_LINE_ADJUST_OFFSET, [UIScreen mainScreen].bounds.size.width,SINGLE_LINE_WIDTH)];
