//
//  ServiceCommentinfoCell.m
//  eCarter
//
//  Created by kinsuft173 on 15/7/5.
...
@implementation ServiceCommentinfoCell
...
- (void)awakeFromNib {
    ...
    UIView *underView=[[UIView alloc]initWithFrame:CGRectMake(0, 40.0 - SINGLE_LINE_ADJUST_OFFSET, [UIScreen mainScreen].bounds.size.width,SINGLE_LINE_WIDTH)];
